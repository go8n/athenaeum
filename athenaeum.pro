SOURCES      = athenaeum/*.qml
TRANSLATIONS = athenaeum/translations/athenaeum_la.ts \
               athenaeum/translations/athenaeum_ja.ts \
               athenaeum/translations/athenaeum_ab.ts \
               athenaeum/translations/athenaeum_zh_Hant.ts \
